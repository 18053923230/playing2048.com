...
// 三月节日数据
export const marchHolidays: Holiday[] = [
  {
    date: "03-01",
  ...
  },
  {
    ...
    article: {
      ...
      modernCelebrations:
        "People enjoy chocolate caramel treats, bakeries offer special desserts, and communities share chocolate caramel recipes and traditions.",
      educationalValue:
